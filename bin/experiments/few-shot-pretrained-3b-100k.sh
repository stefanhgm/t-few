...
do
  ...
  # TODO: Set per experiment
  for num_shot in all #4 8 16 32 64 128 256 512 # 64 256 1024 4096 16384
  do
  ...
  # TODO: Set per experiment
    ...
    do
      ...
      do
        CUDA_VISIBLE_DEVICES=${cuda_device} CONFIG_PATH=/home/stefanhg/t-few/configs HF_HOME=/home/stefanhg/.cache/huggingface \
