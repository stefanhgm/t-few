...
do
  ...
  # TODO: Set per experiment
  for num_shot in 64 # 64 256 1024 4096 16384
  do
  ...
  # TODO: Set per experiment
    ...
    do
      ...
      do
        CUDA_VISIBLE_DEVICES=${cuda_device} CONFIG_PATH=/root/t-few/configs HF_HOME=/home/stefanhg/.cache/huggingface \
